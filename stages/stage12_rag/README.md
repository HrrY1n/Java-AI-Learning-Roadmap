...
- 完成真实 LLM API、结构化输出和 Tool Calling。
...
4. TODO：建立 20 条以上带期望引用的评测集。
5. TODO：评估 retrieval recall、引用正确性、回答相关性和拒答。
6. Review：分析失败样本，不用“换更大模型”掩盖检索问题。
